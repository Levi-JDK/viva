-- ============================================================
-- FUNCIÓN: fun_carrito
-- DESCRIPCIÓN: Gestiona todas las operaciones del carrito de
--              compras de un usuario. Realiza las validaciones
--              necesarias antes de ejecutar cualquier cambio y
--              siempre retorna el estado actualizado del carrito
--              como JSON.
--
-- PARÁMETROS:
--   p_id_user    INTEGER       → ID del usuario autenticado
--   p_accion     VARCHAR       → Acción a ejecutar:
--                                  'agregar'    - Agrega o suma cantidad
--                                  'eliminar'   - Elimina un ítem del carrito
--                                  'actualizar' - Cambia la cantidad de un ítem
--                                  'limpiar'    - Vacía todo el carrito
--                                  'obtener'    - Solo consulta, sin modificar
--   p_id_producto DECIMAL(12,0)→ ID del producto (requerido para agregar/eliminar/actualizar)
--   p_cantidad    INTEGER       → Cantidad (requerido para agregar/actualizar)
--
