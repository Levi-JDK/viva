...
BEGIN
  ...
  INSERT INTO tab_productos(id_producto,nom_producto,stock,id_categoria,id_color,id_oficio,id_materia)
  VALUES (p_id_producto,p_nom_producto,p_stock,p_id_categoria,p_id_color,p_id_oficio,p_id_materia);
